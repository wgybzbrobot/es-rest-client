...
import com.jusdt.es.client.http.HttpDeleteWithEntity;
import com.jusdt.es.client.http.HttpGetWithEntity;
...
public class JestHttpClientTest {
	...
	public void addHeadersToRequest() throws IOException {
		...
		Search search = new Search.Builder(query)
				...
				.addIndex("twitter").addType("tweet").setHeader(headerKey, headerValue).build();
	...
	public void prepareShouldNotRewriteLongToDoubles() throws IOException {
		...
		Search search = new Search.Builder(query)
				// multiple index or types can be added.
				.addIndex("twitter").addType("tweet").addSort(mockSort).build();
		...
		String payload = EntityUtils.toString(entity, Charset.defaultCharset().toString());
