...
import com.jusdt.es.common.core.search.aggregation.ExtendedStatsAggregation;
...
public class ExtendedStatsAggregationIntegrationTest extends AbstractIntegrationTest {
	...
	@Test
	public void testGetExtendedStatsAggregation() throws IOException {
		createIndex(INDEX);
		...
		ExtendedStatsAggregation extendedStats = result.getAggregations()
				.getExtendedStatsAggregation("extended_stats1");
		...
		Aggregation aggregation = result.getAggregations().getAggregation("extended_stats1",
				ExtendedStatsAggregation.class);
