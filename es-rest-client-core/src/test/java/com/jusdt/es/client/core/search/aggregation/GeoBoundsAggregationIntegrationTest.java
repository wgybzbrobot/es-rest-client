...
import com.jusdt.es.common.core.search.aggregation.GeoBoundsAggregation;
...
public class GeoBoundsAggregationIntegrationTest extends AbstractIntegrationTest {
	...
	public void testGeoBoundsAggregation() throws IOException {
		...
		index(INDEX, TYPE, null,
				"{\"location\" : {\"lat\" : 40.12,\"lon\" : -71.34},\"tag\" : [\"food\", \"family\"]}");
		index(INDEX, TYPE, null,
				"{\"location\" : {\"lat\" : 38.53999991901219,\"lon\" : -71.78000008687377},\"tag\" : [\"gas\", \"food\"]}");
		index(INDEX, TYPE, null,
				"{\"location\" : {\"lat\" : 41.229999996721745,\"lon\" : -70.67000007256866},\"tag\" : [\"gas\"]}");
		refresh();
