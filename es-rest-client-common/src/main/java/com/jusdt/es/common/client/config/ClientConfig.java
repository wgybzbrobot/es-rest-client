...
public class ClientConfig {
	...
	@Override
	public int hashCode() {
		return Objects.hash(serverList, isMultiThreaded, isDiscoveryEnabled, isRequestCompressionEnabled,
				discoveryFrequency, discoveryFilter, connTimeout, readTimeout, discoveryFrequencyTimeUnit,
				maxConnectionIdleTime, maxConnectionIdleTimeDurationTimeUnit, gson, defaultSchemeForDiscoveredNodes);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(serverList, rhs.serverList) && Objects.equals(isMultiThreaded, rhs.isMultiThreaded)
				...
				&& Objects.equals(discoveryFilter, rhs.discoveryFilter) && Objects.equals(connTimeout, rhs.connTimeout)
	...
	protected static abstract class AbstractBuilder<T extends ClientConfig, K extends AbstractBuilder<T, K>> {
		...
		protected Set<String> serverList = new LinkedHashSet<>();
