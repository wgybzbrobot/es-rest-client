...
import com.jusdt.es.common.cloning.CloneUtils;
import com.jusdt.es.common.core.search.aggregation.MetricAggregation;
import com.jusdt.es.common.core.search.aggregation.RootAggregation;
...
public class SearchResult extends QueryResult {
			...
			if (keys != null) { // keys would never be null in a standard search scenario (i.e.: unless search class is overwritten)
				...
				if (obj.isJsonObject()) {
					...
					for (JsonElement hitElement : obj.getAsJsonArray()) {
						sourceList.add(
								extractHit(sourceType, explanationType, hitElement, sourceKey, addEsMetadataFields));
						if (returnSingle)
							break;
					}
				}
	...
	public class Hit<T, K> {
		...
		public Hit(Class<T> sourceType, JsonElement source, Class<K> explanationType, JsonElement explanation,
			...
			this(sourceType, source, explanationType, explanation, highlight, sort, null, null, null, null, null, null,
					null);
		}
		...
		public Hit(T source, K explanation, Map<String, List<String>> highlight, List<String> sort, String index,
				String type, String id, Double score, List<String> matchedQueries) {
			this.source = source;
		...
		@Override
		public int hashCode() {
			return Objects.hash(source, explanation, highlight, sort, index, type, id);
		}
		...
		public boolean equals(Object obj) {
			...
			Hit<?, ?> rhs = (Hit<?, ?>) obj;
			return Objects.equals(source, rhs.source) && Objects.equals(explanation, rhs.explanation)
					&& Objects.equals(highlight, rhs.highlight) && Objects.equals(sort, rhs.sort)
					&& Objects.equals(index, rhs.index) && Objects.equals(type, rhs.type) && Objects.equals(id, rhs.id);
		}
